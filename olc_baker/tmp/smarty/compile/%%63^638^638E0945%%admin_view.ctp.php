<?php /* Smarty version 2.6.22, created on 2009-10-29 22:42:19
         compiled from default/views/default/admin_view.ctp */ ?>
...
<div class="actions">
    <ul>
        <li><?php echo '<?php'; ?>
 echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('<?php echo $this->_tpl_vars['modelName']; ?>
...
AdminViewControl')); <?php echo '?>'; ?>
        ...
        <li><?php echo '<?php'; ?>
 echo $html->link('設定相關<?php echo $this->_tpl_vars['models'][$this->_tpl_vars['rOption']['className']]['label']; ?>
', array('controller' => '<?php echo $this->_tpl_vars['models'][$this->_tpl_vars['rOption']['className']]['table_name']; ?>
', 'action' => 'index', '<?php echo $this->_tpl_vars['modelName']; ?>
', $this->data['<?php echo $this->_tpl_vars['modelName']; ?>
']['id'], 'set'), array('class' => '<?php echo $this->_tpl_vars['controllerName']; ?>
AdminViewControl')); <?php echo '?>'; ?>
</li>
<?php endforeach; endif; unset($_from); ?>
<?php endif; ?>
...
AdminViewControl\').click(function() {
        $(\'#<?php echo $this->_tpl_vars['controllerName']; ?>
AdminViewPanel\').load(this.href);
        return false;
    });
});
');
