...
class dot_base
{
     ...
     * @param $value integer
     */
    public function dot_base($type, $value=null)
    {
        $this->type = $type;
        if( isset( $value ) )
            $this->value( $value );
...
{
    public function hollow_dot($value=null)
    {
...
class star extends dot_base
{
     ...
     */
    public function star($value=null)
    {
...
class bow extends dot_base
{
     ...
     * The constructor, takes an optional $value
     */
    public function bow($value=null)
    {
...
class anchor extends dot_base
{
     ...
     * The constructor, takes an optional $value
     */
    public function anchor($value=null)
    {
...
class dot extends dot_base
{
     ...
     * The constructor, takes an optional $value
     */
    public function dot($value=null)
    {
...
class solid_dot extends dot_base
{
     ...
     * The constructor, takes an optional $value
     */
    public function solid_dot($value=null)
    {
