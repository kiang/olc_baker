...
class ofc_menu_item
{
     ...
     * some example code.
     */
    public function ofc_menu_item($text, $javascript_function_name)
    {
        $this->type = "text";
        $this->text = $text;
...
class ofc_menu_item_camera
{
     ...
     */
    public function ofc_menu_item_camera($text, $javascript_function_name)
    {
...
class ofc_menu
{
    public function ofc_menu($colour, $outline_colour)
    {
        $this->colour = $colour;
