...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			...
			<?php echo $html->link(__('Sub group', true), array('action'=>'index', $group['Group']['id'])); ?>
			<?php echo $html->link(__('Permission', true), array('action'=>'acos', $group['Group']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
...
<div class="actions">
	<ul>
		<?php if($parentId > 0): ?>
		<li><?php echo $html->link(__('Upper level', true), array('action'=>'index', $upperLevelId)); ?></li>
		<?php endif; ?>
		<li><?php echo $html->link(__('New', true), array('action'=>'add', $parentId), array('class' => 'GroupsAdminIndexControl')); ?></li>
        <li><?php echo $html->link(__('Members', true), array('controller'=>'members')); ?></li>
	</ul>
</div>
